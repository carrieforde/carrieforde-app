...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__projects_block__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hero_heading_block__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hero_heading_block___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__hero_heading_block__);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_getPosts__ = __webpack_require__(9);
...
registerBlockType('carrieforde-app/projects', {
  ...
  edit: function edit(props) {
    ...
    return React.createElement(__WEBPACK_IMPORTED_MODULE_0__components_getPosts__["a" /* default */], null);
  },
...
var Utilities = function () {
  ...
  Utilities.prototype.getData = function getData() {
    var endpoint = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'posts';
    var cb = arguments[1];

    fetch('http://fordeapp.test/wp-json/wp/v2/' + endpoint).then(function (response) {
...
var GetPosts = function (_Component) {
  ...
  function GetPosts(props) {
    ...
    _this.utils = new __WEBPACK_IMPORTED_MODULE_1__utilities__["a" /* default */]();

    _this.updatePosts = _this.updatePosts.bind(_this);
    return _this;
  }

  GetPosts.prototype.updatePosts = function updatePosts(posts) {
    this.setState({ posts: posts });
  };

  GetPosts.prototype.componentDidMount = function componentDidMount() {
    var count = this.props.count;

    this.utils.getData('portfolio' + (count ? '?per_page=${count}' : ''), this.updatePosts);
  };

  GetPosts.prototype.render = function render() {
...
registerBlockType('carrieforde-app/hero-heading', {
  ...
  edit: function edit(props) {
    ...
    return React.createElement(
      ...
      React.createElement(RichText, {
        ...
        onChange: function onChange(footer) {
          return setAttributes({ footer: footer });
        }
      })
    );
  },
  ...
  save: function save(props) {
    ...
    return React.createElement(
      'section',
      { className: 'hero-heading full-width' },
      React.createElement(
        'h1',
        { className: 'hero-heading__title' },
        attributes.title
      ),
      React.createElement(
        'div',
        { className: 'hero-heading__text' },
        attributes.content
      ),
      React.createElement(
        'footer',
        { className: 'hero-heading__footer' },
        attributes.footer
      )
    );
  }
