<?php
/**
 * Carrie_Forde_App Test Bootstrapper.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
function _manually_load_carrieforde_app_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/carrieforde-app.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_carrieforde_app_plugin' );
